...
#create nonroot user
useradd user
echo 'user:0penBmc' | chpasswd
usermod -aG sudo user

#enable i2c im kernel
echo "overlays=i2c0 i2c1" >> /boot/armbianEnv.txt
echo "verbosity=7" >> /boot/armbianEnv.txt
...
#download and install gpio library
cd /home/user
